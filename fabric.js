 ...
 */
function readFabricMod(file) {
    return __awaiter(this, void 0, void 0, function () {
        var fs, content;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, system_1.resolveFileSystem(file)];
                case 1:
                    fs = _a.sent();
                    return [4 /*yield*/, fs.readFile("fabric.mod.json", "utf-8")];
                case 2:
                    content = _a.sent();
                    return [2 /*return*/, JSON.parse(content.replace(/^\uFEFF/, ""))];
            }
        });
    });
}
