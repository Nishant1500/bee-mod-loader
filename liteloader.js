...
function readLiteloaderMod(mod) {
    return __awaiter(this, void 0, void 0, function () {
        var fs, text, metadata;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, system_1.resolveFileSystem(mod)];
                case 1:
                    fs = _a.sent();
                    return [4 /*yield*/, fs.readFile("litemod.json", "utf-8").then(function (s) { return s.replace(/^\uFEFF/, ""); }).catch(function () { return undefined; })];
                case 2:
                    text = _a.sent();
                    if (!text) {
                        throw {
                    ...
                    metadata = JSON.parse(text.trim(), function (key, value) { return key === "revision" ? Number.parseInt(value, 10) : value; });
                    if (!metadata.version) {
